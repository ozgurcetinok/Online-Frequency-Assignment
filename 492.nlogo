...
[
  ...
  stop]
    ...
    create-calls random-poisson callmean[
    set starttime time
...
1124
302
Number of Colors Used in Given Time
NIL
NIL
0.0
10.0
...
"" ""
PENS
"White" 1.0 0 -16777216 true "" "plot count calls with [color = black]"
"Yellow" 1.0 0 -1184463 true "" "plot count calls with [color = yellow]"
"Brown" 1.0 0 -6459832 true "" "plot count calls with [color = brown]"
"Blue" 1.0 0 -13791810 true "" "plot count calls with [color = blue]"
...
<experiments>
  <experiment name="experiment" repetitions="5" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>totalsupport</metric>
    <metric>totalvisit</metric>
    <metric>count fans</metric>
    <metric>socialeffect</metric>
    <enumeratedValueSet variable="ticketprice">
      <value value="60"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="no-of-fans">
      <value value="1500"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="stadium-size">
      <value value="300"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
